            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <ul class="navbar-nav">
                  ...
                  "
                        ...
                        >
                            <a class="dropdown-item" href="#">Amobea & Agile Philoshophy</a>
                            <a class="dropdown-item" href="#">What is Blog and Me</a>
                            <a class="dropdown-item" href="#">Trust hub & Security</a>
                            <a class="dropdown-item" href="#">Compliance</a>
                            <a class="dropdown-item" href="#">FAQs</a>
                            <a class="dropdown-item" href="#">Watch Demo</a>
                        </div>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link navbar--item" href="/enterprise.html">Enterprise</a>
                    </li>
                    <li class="nav-item dropdown">
                        <a
                            class="
                  ...
                  "
                        ...
                        <div
                            ...
                            aria-labelledby="navbarDropdownMenuLink"
                        >
                            <a class="dropdown-item" href="/ebooks.html">Ebook</a>
                            <a class="dropdown-item" href="/blog.html">Blog</a>
                            <a class="dropdown-item" href="#">Use case</a>
                  ...
                  "
                        ...
                        <div
                            ...
                            aria-labelledby="navbarDropdownMenuLink"
                        >
                            <a class="dropdown-item" href="#">Học viện Agile</a>
                            <a class="dropdown-item" href="#">Chương trình dành riêng cho 10 đối tác</a>
                            <a class="dropdown-item" href="#">Referal</a>
                            <a class="dropdown-item" href="#">API with other Platform</a>
...
{{--            </div>--}}
    ...
    <div class="container section-1">
        <h1 class="header-title">
            NỀN TẢNG GIAO TIẾP LIỀN MẠCH HÀNG ĐẦU CHO DOANH NGHIỆP
        </h1>
        <div class="row">
            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 col-12 description-wrapper">
                <h6 class="description">
                    <p>Blog and Me thúc đẩy triệt để toàn bộ hoạt động cộng tác của doanh nghiệp.</p>
                    <p>Dưa trên giao diện duy nhất kết nối hệ thống thông tin</p>
                </h6>
                <div class="button">
                    ...
                    <button class="button-filled">Trải nghiệm ngay</button>
                </div>
            </div>
            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 col-12 thumbnail-wrapper">
...
<div class="white-section">
    <div class="container section-2">
        <div class="row featured">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 col-6">
                <div class="list-item" data-tab="tab-3">Quản trị tri thức doanh nghiệp</div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 col-6">
                <div class="list-item" data-tab="tab-4">Chuyển đổi số doanh nghiệp</div>
            </div>
        </div>
        <div id="tab-1" class="tabs">
            <div style="margin-bottom: 40px">
                <p class="bold">
                    Hơn 60% thời gian làm việc hàng ngày dành cho việc xử lý email, tìm
                    kiếm thông tin và giao tiếp, trong đó chỉ có 40% được dành để thực
                    sự làm việc.
                </p>
                <p>
                    Đa số doanh nghiệp dùng kênh chat Zalo, Skype, Viber, Slack,
                    Telegram, Email để trao đổi công việc. Thế nhưng, các kênh này đâu
                    chỉ gồm công việc ...
                </p>
            </div>
            <div class="row">
        ...
        <div id="tab-3" className="tabs">
            <div style="margin-bottom: 40px">
                <p>
                    Ngày nay, nền kinh tế tri thức vô hình tạo ra những áp lực lớn lên các doanh nghiệp. Để không bị bỏ lại phía sau, các doanh nghiệp cần biến mình trở thành những tổ chức học tập liên tục, đổi mới liên tục để tồn tại và phát triển trên thị trường
                </p>
            </div>
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 col-6">
        ...
        <div id="tab-4" className="tabs">
            <div style="margin-bottom: 40px">
                <p class="bold">
                    Câu chuyện ngày này không phải là có chuyển đổi số hay không, mà là chuyển đổi số bắt đầu từ đâu? Hãy để chúng tôi giúp bạn!
                </p>
            </div>
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 col-6">
    ...
    <div class="container section-3">
        <div class="row">
            <div class="col-lg-6 col-md-12 col-sm-12">
                <h2 class="title">
                    SỰ KHÁC BIỆT CỦA "BUSINESS CHAT" VÀ CHAT
                </h2>
                <div>
                    <div class="section-3--different-point">Điểm khác biệt 1</div>
                    <div class="section-3--different-point">Điểm khác biệt 2</div>
                    <div class="section-3--different-point">Điểm khác biệt 3</div>
                    <div class="section-3--different-point">Điểm khác biệt 4</div>
                </div>
            </div>
            <div
...
<div class="white-section">
    <div class="container section-4">
        <h4 class="title">
            GIẢI PHÁP TỐI ƯU 60% THỜI GIAN CHƯA HIỆU QUẢ TRONG GIAO TIẾP CÔNG VIỆC
            ĐỂ TẠO RA KHÁC BIỆT CHO DOANH NGHIỆP
        </h4>
            ...
            <div class="row" style="margin-bottom: 80px">
                ...
                <div class="col-md-6 order-first order-md-last right">
                    <h5 class="section-4--solution-title">
                        Quản trị giao tiếp theo các luồng công việc
                        </h6>
                        <p class="section-4--solution-description">
                            Quản trị giao tiếp theo các luồng công việc Quản trị chi tiết
                            từng thông tin theo đầu việc, biết được người liên quan đến công
                            việc đó đang làm gì, và làm đến đâu. Trạng thái công việc đã
                            được xử lý, cập nhật như thế nào
                        </p>
                </div>
            </div>
            <div class="row" style="margin-bottom: 80px">
...
<div class="grey-section">
    <div class="container section-5">
        <h3 class="title">CHỨNG NHẬN CỦA Blog and Me</h3>
        <div style="margin-top: 40px; margin-bottom: 40px">
            <p class="section-5--description">
                Giới thiệu về chứng chỉ Lorem ipsum dolor sit amet, consectetur
    ...
    <div class="container section-6">
        ...
        <div style="margin-top: 40px; margin-bottom: 80px">
            <p class="section-6--description">
                Danh sách đối tác ngày càng dài thêm là minh chứng cho mối quan hệ
                hợp tác hiệu quả cùng các đối tác tại Việt Nam và nhiều quốc gia
                trên thế giới. Blog and Me tự hào được kể tên các thương hiệu nổi tiếng
                mà chúng tôi đã và đang hợp tác.
            </p>
        </div>
                    ...
                    <form>
                        <div class="form-group">
                            <div class="signup-input">
                                ...
                                <input class="signup-input-text" placeholder="Nhập Email của bạn" />
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="signup-input">
                                ...
                                <input class="signup-input-text" placeholder="Họ và tên" />
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="signup-input">
                                ...
                                <input class="signup-input-text" placeholder="Số điện thoại" />
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
...
<div class="footer">
    <div class="container">
        <div class="row nav-links">
            ...
            <div class="col-lg-2 col-md-12">
                <div class="nav-links-col">
                    <div class="nav-link-header text-14">
                        What is Blog and Me
                    </div>
                    <a href="#"><div class="nav-link-child">Amoeba & Aglie</div></a>
                    <a href="#"><div class="nav-link-child">Blog and Me difference</div></a>
                    <a href="#"><div class="nav-link-child">Trust hub & Sercurity</div></a>
                    <a href="#"><div class="nav-link-child">Compliance</div></a>
                    <a href="#"><div class="nav-link-child">FAQs</div></a>
                    <a href="#"><div class="nav-link-child">Watch Demo</div></a>
                </div>
                <div class="nav-links-col-mobile">
                    <div class="nav-item dropdown">
                        <a
                            class="
                    dropdown-toggle
                    navbar--menu-show
                    nav-link-header text-14
                  "
                            href="#"
                            id="navbarDropdownMenuLink"
                            data-toggle="dropdown"
            ...
            <div class="col-lg-2 col-md-12">
                <div class="nav-links-col">
                    ...
                    <a href="#"><div class="nav-link-child">IT</div></a>
                    <a href="#"><div class="nav-link-child">Education</div></a>
                    <a href="#"><div class="nav-link-child">Tech</div></a>
                    <a href="#"><div class="nav-link-child">Finance</div></a>
                </div>
                <div class="nav-links-col-mobile">
            ...
            <div class="col-lg-2 col-md-12">
                <div class="nav-links-col">
                    ...
                    <a href="/ebooks.html"><div class="nav-link-child">Ebook</div></a>
                    <a href="/blog.html"><div class="nav-link-child">Blog</div></a>
                    <a href="#"><div class="nav-link-child">Success Story</div></a>
                    <a href="#"><div class="nav-link-child">Learning Pool</div></a>
                    <a href="/podcast.html"><div class="nav-link-child">Playlist</div></a>
                </div>
                <div class="nav-links-col-mobile">
                    <div class="nav-item dropdown">
                        <a
            ...
            <div class="col-lg-2 col-md-12">
                <div class="nav-links-col">
                    ...
                    <a href="#"><div class="nav-link-child">Học viện Agile</div></a>
                    <a href="#"><div class="nav-link-child">Private events</div></a>
                    <a href="#"><div class="nav-link-child">Referal</div></a>
                    <a href="#"><div class="nav-link-child">API</div></a>
                    <a href="#"><div class="nav-link-child">Career</div></a>
                </div>
                <div class="nav-links-col-mobile">
                    <div class="nav-item dropdown">
                        <a
                  ...
                  "
                        ...
                        >
                            <a class="dropdown-item" href="#">Học viện Agile</a>
                            <a class="dropdown-item" href="#">Private events</a>
        ...
        <div class="footer--contact row">
            ...
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 col-3 footer--social-links">
                <div>
                    <a href="#">
                        <img
